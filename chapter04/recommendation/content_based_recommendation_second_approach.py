...
if __name__ == '__main__':
    ...
    target_user = recommender.get_option(["-t", "--target_user"], "19")

    top10 = recommender.recommend_to(target_user, 18) #Replace 598 with any other user id you are interested in
    print(top10)