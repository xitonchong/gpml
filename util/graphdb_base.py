...
#https://github.com/alenegro81/gpml/blob/develop/util/graphdb_base.py
help_message = '-i <neo4j username> -p <password> -s <source directory> -b <bolt uri>'
    ...
    def __get_main_parameters__(self, command, argv, extended_options="", extended_long_options=[]):
        try: 
            self.opts, self.args = getopt.getopt(argv, 'hu:p:s:b:'+extended_options,
                    ['help', 'neo4j-user=', 'neo4j-password=', 
                     'source-path=', 'bolt='] + extended_long_options)
